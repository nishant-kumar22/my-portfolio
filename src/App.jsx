...
function App() {
  ...
  const [isLoading, setIsLoading] = useState(true);
   ...
   const [activeProjectSection, setActiveProjectSection] = useState(''); // Add this line
...
<section className="pt-40 pb-20 px-6">
    ...
    <div className="flex flex-wrap justify-center gap-4">
      ...
      <div className="relative resume-dropdown">
        ...
        >
          ...
          Resume
          <svg 
            className={`w-4 h-4 ml-2 transition-transform duration-200 ${isResumeDropdownOpen ? 'rotate-180' : ''}`} 
            fill="currentColor" 
            viewBox="0 0 20 20"
          >
        ...
        {isResumeDropdownOpen && (
          <div className="absolute top-full mt-2 w-80 left-1/2 transform -translate-x-1/2 bg-gray-800 border border-gray-600 rounded-lg shadow-xl z-50 overflow-hidden">
            <div className="py-2">
              ...
              <a 
                href="https://drive.google.com/file/d/1KMq-ew508PqDPhmDqk8zG3c_Y5TEr-Hx/view?usp=sharing" 
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => setIsResumeDropdownOpen(false)}
                className="flex items-center px-4 py-3 hover:bg-gray-700 transition-colors group"
              >
                <div className="w-10 h-10 bg-blue-600/20 rounded-lg flex items-center justify-center mr-3 group-hover:bg-blue-600/30 transition-colors">
                  <svg className="w-5 h-5 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd" />
                  </svg>
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="text-white font-medium truncate">Software Engineering</h3>
                  <p className="text-gray-400 text-sm truncate">Full-stack development & backend systems</p>
                </div>
                <svg className="w-4 h-4 text-gray-400 group-hover:text-white transition-colors flex-shrink-0 ml-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
              </a>
              ...
              <a 
                href="https://drive.google.com/file/d/1E1htDNTRrtzWkrjl83QtQ6rpiraq9bUw/view?usp=sharing" 
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => setIsResumeDropdownOpen(false)}
                className="flex items-center px-4 py-3 hover:bg-gray-700 transition-colors group"
              >
                <div className="w-10 h-10 bg-purple-600/20 rounded-lg flex items-center justify-center mr-3 group-hover:bg-purple-600/30 transition-colors">
                  <svg className="w-5 h-5 text-purple-400" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z" />
                  </svg>
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="text-white font-medium truncate">Machine Learning</h3>
                  <p className="text-gray-400 text-sm truncate">Data science & ML model development</p>
                </div>
                <svg className="w-4 h-4 text-gray-400 group-hover:text-white transition-colors flex-shrink-0 ml-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
              ...
              <a 
                href="https://drive.google.com/file/d/1DnbYjUK6SJERb1JsH0UqpeZjrcJ65eaC/view?usp=sharing" 
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => setIsResumeDropdownOpen(false)}
                className="flex items-center px-4 py-3 hover:bg-gray-700 transition-colors group"
              >
                <div className="w-10 h-10 bg-red-600/20 rounded-lg flex items-center justify-center mr-3 group-hover:bg-red-600/30 transition-colors">
                  <svg className="w-5 h-5 text-red-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M3 4a1 1 0 00-1 1v10a1 1 0 001 1h14a1 1 0 001-1V5a1 1 0 00-1-1H3zm2 3a1 1 0 000 2h.01a1 1 0 100-2H5zm0 3a1 1 0 000 2h3a1 1 0 100-2H5zm10-1a1 1 0 10-2 0v3a1 1 0 102 0v-3z" clipRule="evenodd" />
                  </svg>
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="text-white font-medium truncate">Game Development</h3>
                  <p className="text-gray-400 text-sm truncate">Roblox games & interactive experiences</p>
                </div>
                <svg className="w-4 h-4 text-gray-400 group-hover:text-white transition-colors flex-shrink-0 ml-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3.293-7.707a1 1 0 011.414 0L9 10.586V3a1 1 0 112 0v7.586l1.293-1.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
 ...
 {/* Projects Section - Expandable Categories */}
<section id="projects" className="py-20 px-6">
  <div className="max-w-6xl mx-auto">
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-900 border border-gray-700 rounded-lg overflow-hidden">
        <button
          onClick={() => setActiveProjectSection(activeProjectSection === 'roblox' ? '' : 'roblox')}
                ...
                <div className="grid md:grid-cols-2 gap-0">
                  <div className="h-56 md:h-auto bg-gray-800 border border-gray-700 flex items-center justify-center relative overflow-hidden group-hover:border-blue-500/30 transition-all duration-300">
                    ...
                    <div className="text-center p-4 md:p-8 relative z-10 pt-12 md:pt-8">
                      ...
                      <p className="text-gray-400 text-xs md:text-sm mt-1 md:mt-2">Multiplayer horse racing game</p>
                    </div>
              ...
              <div className="bg-gray-900 rounded-lg overflow-hidden hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300 group">
                <div className="grid md:grid-cols-2 gap-0">
                  <div className="h-56 md:h-auto bg-gray-800 border border-gray-700 flex items-center justify-center relative overflow-hidden group-hover:border-red-500/30 transition-all duration-300">
                    ...
                    <div className="text-center p-4 md:p-8 relative z-10 pt-12 md:pt-8">
                      <div className="text-4xl md:text-6xl mb-2 md:mb-4 filter grayscale group-hover:grayscale-0 transition-all duration-300">🎮</div>
                      <h4 className="text-lg md:text-xl font-bold text-gray-300 group-hover:text-red-400 transition-colors duration-300">Killzone Strike</h4>
                      <p className="text-gray-400 text-xs md:text-sm mt-1 md:mt-2">Multiplayer FPS Game</p>
                    </div>
                    <div className="absolute top-3 left-3 md:bottom-3 md:top-auto">
      ...
      <div className="bg-gray-900 border border-gray-700 rounded-lg overflow-hidden">
        <button
          onClick={() => setActiveProjectSection(activeProjectSection === 'fullstack' ? '' : 'fullstack')}
          className="w-full p-6 text-left hover:bg-gray-800 transition-all duration-300 flex items-center justify-between group"
        >
          <div className="flex items-center space-x-4">
  ...
  <div className="border-t border-gray-700 bg-gray-800/50">
    <div className="p-6 space-y-8">
      ...
      <div className="bg-gray-900 rounded-lg overflow-hidden hover:shadow-xl hover:shadow-green-500/10 transition-all duration-300 group">
        <div className="grid md:grid-cols-2 gap-0">
          <div className="h-56 md:h-auto bg-gray-800 border border-gray-700 flex items-center justify-center relative overflow-hidden group-hover:border-green-500/30 transition-all duration-300">
            ...
            <div className="text-center p-4 md:p-8 relative z-10 pt-12 md:pt-8">
              <div className="text-4xl md:text-6xl mb-2 md:mb-4 filter grayscale group-hover:grayscale-0 transition-all duration-300">⚡</div>
              <h4 className="text-lg md:text-xl font-bold text-gray-300 group-hover:text-green-400 transition-colors duration-300">QuizDuel</h4>
              <p className="text-gray-400 text-xs md:text-sm mt-1 md:mt-2">Real-time 1v1 Quiz Platform</p>
            </div>
            <div className="absolute top-3 left-3 md:bottom-3 md:top-auto">
              <span className="px-2 py-1 bg-green-600/20 border border-green-500/30 text-green-300 text-xs rounded-full">
                Feb 2025 – Mar 2025
          ...
          <div className="p-6">
            <h3 className="text-xl font-bold text-green-400 mb-2">Real-time Quiz Platform</h3>
            <div className="flex flex-wrap gap-1 mb-3">
              {['FastAPI', 'WebSockets', 'React', 'Python', 'Real-time'].map((tech) => (
                <span key={tech} className="px-2 py-1 bg-gray-800 border border-gray-700 text-gray-300 rounded text-xs hover:border-green-500/50 transition-colors">
                  {tech}
                </span>
              ))}
            ...
            <p className="text-gray-300 text-sm mb-4 leading-relaxed">
              Built a <span className="text-green-400">real-time multiplayer quiz platform</span> where users can compete in 1v1 matches. 
              Features live question delivery, instant scoring, and real-time opponent tracking using WebSocket connections 
              for seamless gameplay experience.
            </p>
            <div className="flex space-x-3">
              <a 
      ...
      <div className="bg-gray-900 rounded-lg overflow-hidden hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 group">
        <div className="grid md:grid-cols-2 gap-0">
          <div className="md:order-2 h-56 md:h-auto bg-gray-800 border border-gray-700 flex items-center justify-center relative overflow-hidden group-hover:border-blue-500/30 transition-all duration-300">
            ...
            <div className="text-center p-4 md:p-8 relative z-10 pt-12 md:pt-8">
              <div className="text-4xl md:text-6xl mb-2 md:mb-4 filter grayscale group-hover:grayscale-0 transition-all duration-300">📧</div>
              <h4 className="text-lg md:text-xl font-bold text-gray-300 group-hover:text-blue-400 transition-colors duration-300">AutoMailer</h4>
              <p className="text-gray-400 text-xs md:text-sm mt-1 md:mt-2">AI-Powered Email Automation</p>
            </div>
            <div className="absolute top-3 left-3 md:bottom-3 md:top-auto">
              <span className="px-2 py-1 bg-blue-600/20 border border-blue-500/30 text-blue-300 text-xs rounded-full">
                Nov 2024 – Dec 2024
          ...
          <div className="md:order-1 p-6">
            <h3 className="text-xl font-bold text-blue-400 mb-2">Email Automation Tool</h3>
            <div className="flex flex-wrap gap-1 mb-3">
              {['Node.js', 'Gemini API', 'Gmail API', 'JavaScript', 'AI'].map((tech) => (
                <span key={tech} className="px-2 py-1 bg-gray-800 border border-gray-700 text-gray-300 rounded text-xs hover:border-blue-500/50 transition-colors">
                  {tech}
                </span>
              ))}
            ...
            <p className="text-gray-300 text-sm mb-4 leading-relaxed">
              Developed an <span className="text-blue-400">intelligent email automation system</span> that uses Google's Gemini AI 
              to generate personalized email responses. Integrates with Gmail API for seamless email management and 
              automated workflow processing with smart content generation.
            </p>
            <div className="flex space-x-3">
              <a 
      ...
      <div className="bg-gray-900 border border-gray-700 rounded-lg overflow-hidden">
        <button
          onClick={() => setActiveProjectSection(activeProjectSection === 'ml' ? '' : 'ml')}
          className="w-full p-6 text-left hover:bg-gray-800 transition-all duration-300 flex items-center justify-between group"
        >
          <div className="flex items-center space-x-4">
