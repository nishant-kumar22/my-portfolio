        ...
        <div className="grid md:grid-cols-2 gap-0">
          <div className="h-56 md:h-auto bg-gray-800 border border-gray-700 flex items-center justify-center relative overflow-hidden group-hover:border-blue-500/30 transition-all duration-300">
            ...
            <div className="text-center p-4 md:p-8 relative z-10 pt-12 md:pt-8">
              ...
              <h4 className="text-lg md:text-xl font-bold text-gray-300 group-hover:text-blue-400 transition-colors duration-300">Real-Time Quiz Platform</h4>
              <p className="text-gray-400 text-xs md:text-sm mt-1 md:mt-2">Interactive Quiz Experience</p>
            </div>
          ...
          <div className="p-6">
            <h3 className="text-xl font-bold text-blue-400 mb-2">Real Time 1v1 Quiz Platform</h3>
            <div className="flex flex-wrap gap-1 mb-3">
              {['FastAPI', 'WebSockets', 'JWT', 'MongoDB', 'React'].map((tech) => (
            ...
            <p className="text-gray-300 text-sm mb-4 leading-relaxed">
              Real-time quiz platform with <span className="text-blue-400">WebSocket communication</span> achieving sub-100ms latency. 
              Features secure JWT authentication and optimized React frontend with 25% faster load times.
            </p>
      ...
      <div className="bg-gray-900 rounded-lg overflow-hidden hover:shadow-xl hover:shadow-green-500/10 transition-all duration-300 group">
        <div className="grid md:grid-cols-2 gap-0">
          <div className="md:order-2 h-56 md:h-auto bg-gray-800 border border-gray-700 flex items-center justify-center relative overflow-hidden group-hover:border-green-500/30 transition-all duration-300">
            ...
            <div className="text-center p-4 md:p-8 relative z-10 pt-12 md:pt-8">
              <div className="text-4xl md:text-6xl mb-2 md:mb-4 filter grayscale group-hover:grayscale-0 transition-all duration-300">📧</div>
              <h4 className="text-lg md:text-xl font-bold text-gray-300 group-hover:text-green-400 transition-colors duration-300">Email Automation</h4>
              <p className="text-gray-400 text-xs md:text-sm mt-1 md:mt-2">AI-Powered Processing</p>
            </div>
          ...
          <div className="md:order-1 p-6">
            <h3 className="text-xl font-bold text-green-400 mb-2">Email Automation Tool</h3>
            <div className="flex flex-wrap gap-1 mb-3">
              {['Node.js', 'Gemini API', 'Gmail API', 'OAuth2.0'].map((tech) => (
            ...
            <p className="text-gray-300 text-sm mb-4 leading-relaxed">
              AI-powered email processing tool with <span className="text-green-400">Gmail & Gemini API</span> integration. 
              Processes 1,000+ emails daily with 92% accuracy and reduces manual work by 70%.
            </p>
            <div className="flex space-x-3">
              <a 
